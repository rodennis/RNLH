  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path={'/products/:id/edit'} element={user ? <EditProducts user={user}/> : <Navigate to='/sign-up' setToggle={setToggle}/>}/>
        <Route path={'/add-product'} element={user ? <AddProducts user={user}/> : <Navigate to='/sign-up' setToggle={setToggle}/>}/>
